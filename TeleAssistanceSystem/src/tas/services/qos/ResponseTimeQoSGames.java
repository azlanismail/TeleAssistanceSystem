...
public class ResponseTimeQoSGames implements AbstractQoSRequirement{
	Planner plan;
	 
	@Override
    public ServiceDescription applyQoSRequirement(List<ServiceDescription> serviceDescriptions,String opName,Object[] params) {
	 
	 	System.out.println("Begin planning for min response time based on stochastic games");
		...
		//params: goal type, probe, service type, failedServiceId, retry, wcs, wrt, wfr
 		plan.setConstantsParams(2,-1,serviceType,-1, 1, 0.0, 0.0, 0.0);  		
